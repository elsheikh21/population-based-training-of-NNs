...
# https://medium.com/@yevheniiakryvenko/project-population-based-training-for-machine-translation-with-different-metaheuristic-algorithms-2526d9f6fd1a
...
if __name__ == '__main__':
    ...
    (en_train, en_test, en_tokenizer,
     de_train, de_test, de_tokenizer) = load_wmt(split=0.3)
    ...
    def generator_fn(x, y, shuffle=True, looping=True): return nmt_train_generator(x, y, de_vocab_size, batch_size,
